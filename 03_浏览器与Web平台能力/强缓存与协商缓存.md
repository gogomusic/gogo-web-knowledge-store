...
![image](assets/128ac822e23554d13b4f1823953f27de_MD5.png)
...
![image](assets/9dd41da80b52ba29225fc835b6ecdc25_MD5.png)
...
![image](assets/491bdd0dc6bcace8bc3ed2e9cf5c4463_MD5.png)
...
![image](assets/b33b396bd3e64732425a0dbc93899805_MD5.png)
...
![image](assets/47529d8ca94b68b76cb04580b97930b4_MD5.png)
...
![image](assets/ddbe3915b5b1ba0580e0d9083741f21b_MD5.png)
...
![image](assets/3fa44775a15c235883b217a8675fe8a7_MD5.png)
...
![image](assets/108b15c8aee82808bcc87ae2e5ea5dd9_MD5.png)

查看单个请求的 Response Header，也能看到 304 的状态码和 Not Modified 的字符串，只要看到这个就可说明这个资源是命中了协商缓存，然后从客户端缓存中加载的，而不是服务器最新的资源：

![image](assets/9f4b8fe81057088876ea378951085ead_MD5.png)
...
![image](assets/2e22ccac4ef3128b8a66d2fafcb9fdb5_MD5.png)
...
![image](assets/1c9d01b2414391712c51aee088e10736_MD5.png)

2）浏览器再次跟服务器请求这个资源时，在 request 的 header 上加上 If-None-Match 的 header，这个 header 的值就是上一次请求时返回的 ETag 的值：

![image](assets/b68cbb8c4c4ec5139f92313c74ce257b_MD5.png)
...
![image](assets/e5cb2626ff84a0db62bcb872f8325903_MD5.png)
...
![image](assets/9f3b4d0e30168c057e349391a631bec9_MD5.png)
...
![image](assets/f679c67f65f0beb8d9dd7083afb650bf_MD5.png)
