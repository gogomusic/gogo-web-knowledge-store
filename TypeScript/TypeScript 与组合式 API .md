...
created: 2023-07-10 09:03
source: https://cn.vuejs.org/guide/typescript/composition-api.html#typing-component-template-refs
...
---
> 这一章假设你已经阅读了 [搭配 TypeScript 使用 Vue](https://cn.vuejs.org/guide/typescript/overview.html) 的概览。
...
当使用基于类型的声明时，我们失去了对 props 定义默认值的能力。这可以通过目前实验性的 [响应性语法糖](https://cn.vuejs.org/guide/extras/reactivity-transform.html#reactive-props-destructure) 来解决：
...
这个行为目前需要 [显式地选择开启](https://cn.vuejs.org/guide/extras/reactivity-transform.html#explicit-opt-in)。
...
如果组件是全局组件并在 main.ts 中注册，则可以导出其类型以供父组件使用

```ts
// main.ts
import Loading from '/@/components/Loading.vue'
export type LoadingType = InstanceType<typeof Loading>
```
...
<script lang=ts>
...
import type { LoadingType } from '/@/main'
</script>
```
